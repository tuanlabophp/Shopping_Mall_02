        ...
        <ul>
            ...
            <li>
                ...
                <ul>
                    ...
                    <li class="price" price-range = '1-5'>{{ trans('sites.price_1m_3m') }}</li>
                    <li class="price" price-range = '5-10'>{{ trans('sites.price_3m_7m') }}</li>
                    <li class="price" price-range = '>10'>{{ trans('sites.price_7m_10m') }}</li>
                </ul>
            </li>
            <li>
